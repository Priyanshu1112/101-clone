...
const WeeklyLeaveSummaryHeader: React.FC = () => {
  ...
  return (
    <div className="p-4 bg-gray-50 border border-gray-100 rounded-t-lg border-b-0">
      ...
      {/* Subtext Link */}
        ...
        <Typography
          text="This will provide weekly leave updates for the team"
          variant="label"
...
export default WeeklyLeaveSummaryHeader;
